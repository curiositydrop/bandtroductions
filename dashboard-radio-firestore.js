...
function actions(){
  return '<div class="bt-radio-actions"><a class="btn bt-radio-submit" href="radio-submit.html">SUBMIT MUSIC FOR AIRPLAY</a><a class="btn" href="radio-sponsor.html">SPONSOR RADIO HERE</a></div>';
}
