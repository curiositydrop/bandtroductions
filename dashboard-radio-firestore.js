...
style.textContent=`
.bt-radio-panel{border-color:var(--teal)!important;box-shadow:0 0 18px rgba(37,199,193,.15)!important;overflow:hidden!important;background:linear-gradient(180deg,rgba(1,7,8,.06),rgba(1,7,8,.18)),url("bt-radio-panel-real-crisp.jpg?v=20260907-radio15") center center/100% 100% no-repeat!important}
