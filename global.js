...
if(location.pathname.endsWith('/admin.html')){import('./admin-claims.js?v=4').catch(error=>console.error('Error loading ownership claims queue:',error));import('./admin-managed-profiles.js?v=5').catch(error=>console.error('Error loading managed profiles dashboard:',error))}
